...
def main():
    ...
    for mid in mids:
        ...
        # Call with gemini-2.5-flash
        url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=" + gastos_bancarios.GEMINI_API_KEY
        body = json.dumps({
        ...
        try:
            ...
            with urllib.request.urlopen(req, timeout=30) as resp:
                ...
                finish = raw['candidates'][0].get('finishReason', 'UNKNOWN')
                print(f"Finish Reason: {finish} | Usage: {usage}")
                print("Response:")
                print(text.strip())
